...
.sbar .b{width:3px;border-radius:1px;background:#222;}\
.sbar .b.on.e{background:#4caf50;}\
.sbar .b.on.g{background:#8bc34a;}\
.sbar .b.on.f{background:#ffc107;}\
.sbar .b.on.w{background:#ff9800;}\
.sbar .b.on.p{background:#f44336;}\
